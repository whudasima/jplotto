function whoAreYou() {
  var e = $.browser.original,
    t = $.platform.type,
    n = $.platform.original;
  "msie" == e ? $("html").addClass("msie") : ($("html").addClass("no-msie " + e + " " + t + " " + n), $("html").hasClass("tablet") && ($("meta[name=viewport]").attr("content", "width=1280, initial-scale=1"), $("html").addClass("tablet")))
}
...
function initRollOverImages() {
  var r = new Object;
  $("img.Hover").not("[src*='_on.']").each(function (e) {
    var t = this.src,
      n = t.replace("_off", "_on");
    r[this.src] = new Image, r[this.src].src = n, $(this).hover(function () {
      this.src = n
    }, function () {
      this.src = t
    })
...
function accordionBtn() {
  $(".contents-3dsecure h3").on("click", function () {
    $(".contents-3dsecure h3").toggleClass("secure-open"), $(".contents-3dsecure div").slideToggle(300)
  }), $(".contents-3dsecure h3").on("keypress", function (e) {
    if (13 == e.which) return $(".contents-3dsecure h3").toggleClass("secure-open"), $(".contents-3dsecure div").slideToggle(300), !1
  })
}

function accordionBtn2() {
  $(".title2caution-list h3").on("click", function () {
    $(".title2caution-list h3").toggleClass("list-open"), $(".title2caution-list div").slideToggle(300)
  }), $(".title2caution-list h3").on("keypress", function (e) {
    if (13 == e.which) return $(".title2caution-list h3").toggleClass("list-open"), $(".title2caution-list div").slideToggle(300), !1
  })
}


function commonTrigger() {
  whoAreYou(), accordionBtn(), accordionBtn2()
}! function (e, t) {
  "use strict";
  ...
  var d = function (n) {
    var e, d, b, o, i, h, f, g, w, u, l, T, C, a, k, m, s, c, y, E = "sizzle" + 1 * new Date,
      v = n.document,
      j = 0,
      r = 0,
      p = ae(),
    ...
    try {
      q.apply(t = L.call(v.childNodes), v.childNodes), t[v.childNodes.length].nodeType
    } catch (n) {
      q = {
      ...
      if (!r && ((t ? t.ownerDocument || t : v) !== C && T(t), t = t || C, k)) {
        ...
        if (d.qsa && !S[e + " "] && (!m || !m.test(e))) {
          if (1 !== p) f = t, c = e;
            ...
            for ((s = t.getAttribute("id")) ? s = s.replace(te, ne) : t.setAttribute("id", s = E), o = (l = h(e)).length; o--;) l[o] = "#" + s + " " + ye(l[o]);
    ...
    for (e in d = oe.support = {}, i = oe.isXML = function (e) {
        ...
        return r !== C && 9 === r.nodeType && r.documentElement && (a = (C = r).documentElement, k = !i(C), v !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", re, !1) : n.attachEvent && n.attachEvent("onunload", re)), d.attributes = ue(function (e) {
        ...
        }), m = m.length && new RegExp(m.join("|")), s = s.length && new RegExp(s.join("|")), t = G.test(a.compareDocumentPosition), y = t || G.test(a.contains) ? function (e, t) {
          ...
          return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !d.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === v && y(v, e) ? -1 : t === C || t.ownerDocument === v && y(v, t) ? 1 : u ? M(u, e) - M(u, t) : 0 : 4 & n ? -1 : 1)
        } : function (e, t) {
          if (e === t) return l = !0, 0;
          var n, r = 0,
            i = e.parentNode,
        ...
        if ((e.ownerDocument || e) !== C && T(e), t = t.replace(z, "='$1']"), d.matchesSelector && k && !S[t + " "] && (!s || !s.test(t)) && (!m || !m.test(t))) try {
          var n = c.call(e, t);
        ...
        preFilter: {
          ...
          PSEUDO: function (e) {
            var t, n = !e[6] && e[2];
            return U.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && Q.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
          }
        },
        filter: {
          TAG: function (e) {
            ...
            return 1 === g && 0 === m ? function (e) {
              ...
              if (c) {
                ...
                if (u = [v ? c.firstChild : c.lastChild], v && p) {
                  for (d = (s = (r = (i = (o = (a = c)[E] || (a[E] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === j && r[1]) && r[2], a = s && c.childNodes[s]; a = ++s && a && a[l] || (d = s = 0) || u.pop();)
                    if (1 === a.nodeType && ++d && a === e) {
                      i[h] = [j, s, d];
                      break
                    }
                } else if (p && (d = s = (r = (i = (o = (a = e)[E] || (a[E] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === j && r[1]), !1 === d)
                  for (;
                    (a = ++s && a && a[l] || (d = s = 0) || u.pop()) && ((x ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++d || (p && ((i = (o = a[E] || (a[E] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [j, d]), a !== e)););
          ...
          for (; e = e[u];)
            if (1 === e.nodeType || f)
              if (i = (o = e[E] || (e[E] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase()) e = e[u] || e;
                ...
                if ((r = i[c]) && r[0] === j && r[1] === p) return a[2] = r[2];
    ...
    function we(d, h, g, m, y, e) {
      return m && !m[E] && (m = we(m)), y && !y[E] && (y = we(y, e)), se(function (e, t, n, r) {
        var i, o, a, s = [],
          u = [],
          l = t.length,
          c = e || function (e, t, n) {
        ...
        if (t = b.relative[e[s].type]) c = [ve(xe(c), t)];
          ...
          if ((t = b.filter[e[s].type].apply(null, e[s].matches))[E]) {
            ...
            return we(1 < s && xe(c), 1 < s && ye(e.slice(0, s - 1).concat({
              value: " " === e[s - 2].type ? "*" : ""
            })).replace(W, "$1"), t, s < n && Te(e.slice(s, n)), n < r && Te(e = e.slice(n)), n < r && ye(e))
          }
          c.push(t)
        }
      return xe(c)
    ...
    return me.prototype = b.filters = b.pseudos, b.setFilters = new me, h = oe.tokenize = function (e, t) {
      ...
      for (a = e, s = [], u = b.preFilter; a;) {
        for (o in n && !(r = F.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])), n = !1, (r = _.exec(a)) && (n = r.shift(), i.push({
            value: n,
            type: r[0].replace(W, " ")
          }), a = a.slice(n.length)), b.filter) !(r = U[o].exec(a)) || u[o] && !(r = u[o](r)) || (n = r.shift(), i.push({
          value: n,
          type: o,
          matches: r
        }), a = a.slice(n.length));
      ...
      if (!a) {
        ...
        (a = S(e, (m = o, y = i, v = 0 < y.length, x = 0 < m.length, r = function (e, t, n, r, i) {
          var o, a, s, u = 0,
            l = "0",
            c = e && [],
            f = [],
          ...
          if (u += l, v && l !== u) {
            ...
            q.apply(r, f), i && !e && 0 < f.length && 1 < u + y.length && oe.uniqueSort(r)
          }
          return i && (j = h, w = p), c
        }, v ? se(r) : r))).selector = e
      }
      ...
      if (n = n || [], 1 === c.length) {
        ...
        for (i = U.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !b.relative[s = a.type]);)
          if ((u = b.find[s]) && (r = u(a.matches[0].replace(Z, ee), K.test(o[0].type) && ge(t.parentNode) || t))) {
            if (o.splice(i, 1), !(e = r.length && ye(o))) return q.apply(n, r), n;
            break
          }
      }
  ...
  (E.fn.init = function (e, t, n) {
    var r, i;
    if (!e) return this;
    if (n = n || N, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : v(e) ? void 0 !== n.ready ? n.ready(e) : e(E) : E.makeArray(e, this);
  ...
  E.Callbacks = function (r) {
        ...
        add: function () {
          return s && (t && !i && (l = s.length - 1, u.push(t)), function n(e) {
            E.each(e, function (e, t) {
              v(t) ? r.unique && f.has(t) || s.push(t) : t && t.length && "string" !== w(t) && n(t)
            })
        ...
        a = {
          ...
          then: function (t, n, r) {
                ...
                var n = this,
                  ...
                  e = function () {
                    ...
                    if (!(i < u)) {
                      ...
                      t = e && ("object" == typeof e || "function" == typeof e) && e.then, v(t) ? s ? t.call(e, l(u, o, H, s), l(u, o, P, s)) : (u++, t.call(e, l(u, o, H, s), l(u, o, P, s), l(u, o, H, o.notifyWith))) : (a !== H && (n = void 0, r = [e]), (s || o.resolveWith)(n, r))
                    }
                  },
                  t = s ? e : function () {
                    try {
                      ...
                      E.Deferred.exceptionHook && E.Deferred.exceptionHook(e, t.stackTrace), u <= i + 1 && (a !== P && (n = void 0, r = [e]), o.rejectWith(n, r))
                    }
                  };
            ...
            return E.Deferred(function (e) {
              o[0][3].add(l(0, e, v(r) ? r : H, e.notifyWith)), o[1][3].add(l(0, e, v(t) ? t : H)), o[2][3].add(l(0, e, v(n) ? n : P))
            }).promise()
          },
          promise: function (e) {
    ...
    when: function (e) {
      ...
      if (n <= 1 && ($(e, o.done(a(t)).resolve, o.reject, !n), "pending" === o.state() || v(i[t] && i[t].then))) return o.then();
  ...
  function W() {
    k.removeEventListener("DOMContentLoaded", W), C.removeEventListener("load", W), E.ready()
  }
  ...
  }), E.ready.then = B.then, "complete" === k.readyState || "loading" !== k.readyState && !k.documentElement.doScroll ? C.setTimeout(E.ready) : (k.addEventListener("DOMContentLoaded", W), C.addEventListener("load", W));
  var F = function (e, t, n, r, i, o, a) {
      ...
      else if (void 0 !== r && (i = !0, v(r) || (a = !0), l && (t = a ? (t.call(e, r), null) : (l = t, function (e, t, n) {
          return l.call(E(e), n)
        })), t))
  ...
  function X(e) {
    return e.replace(_, "ms-").replace(z, Q)
  }
  var U = function (e) {
  ...
  he = k.createDocumentFragment().appendChild(k.createElement("div")), (ge = k.createElement("input")).setAttribute("type", "radio"), ge.setAttribute("checked", "checked"), ge.setAttribute("name", "t"), he.appendChild(ge), y.checkClone = he.cloneNode(!0).cloneNode(!0).lastChild.checked, he.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!he.cloneNode(!0).lastChild.defaultValue;
  var ve = k.documentElement,
    xe = /^key/,
  ...
  E.event = {
    ...
    add: function (t, e, n, r, i) {
      var o, a, s, u, l, c, f, p, d, h, g, m = Y.get(t);
      if (m)
        for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(ve, i), n.guid || (n.guid = E.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function (e) {
            return void 0 !== E && E.event.triggered !== e.type ? E.event.dispatch.apply(t, arguments) : void 0
          }), l = (e = (e || "").match(I) || [""]).length; l--;) d = g = (s = we.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = E.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = E.event.special[d] || {}, c = E.extend({
          type: d,
          origType: g,
          data: r,
          handler: n,
    ...
    remove: function (e, t, n, r, i) {
      var o, a, s, u, l, c, f, p, d, h, g, m = Y.hasData(e) && Y.get(e);
      if (m && (u = m.events)) {
  ...
  function Me(n, r, i, o) {
    ...
    if (f && (t = (e = ye(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
      for (s = (a = E.map(pe(e, "script"), Oe)).length; c < f; c++) u = e, c !== p && (u = E.clone(u, !0, !0), s && E.merge(a, pe(u, "script"))), i.call(n[c], u, c);
      if (s)
        for (l = a[a.length - 1].ownerDocument, E.map(a, qe), c = 0; c < s; c++) u = a[c], ce.test(u.type || "") && !Y.access(u, "globalEval") && E.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && E._evalUrl(u.src) : b(u.textContent.replace(De, ""), l, u))
    }
    return n
  }
  ...
  E.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || pe(e), a = a || pe(c), r = 0, i = o.length; r < i; r++) Le(o[r], a[r]);
        else Le(e, c);
  ...
  function Re(e, t, n) {
    ...
    return (n = n || Pe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || E.contains(e.ownerDocument, e) || (a = E.style(e, t)), !y.pixelBoxStyles() && He.test(a) && $e.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
  }
  ...
  function Be(e, t) {
    ...
    function e() {
      if (u) {
        s.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", u.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", ve.appendChild(s).appendChild(u);
        var e = C.getComputedStyle(u);
        n = "1%" !== e.top, a = 12 === t(e.marginLeft), u.style.right = "60%", o = 36 === t(e.right), r = 36 === t(e.width), u.style.position = "absolute", i = 36 === u.offsetWidth || "absolute", ve.removeChild(s), u = null
      }
    }
    ...
    var n, r, i, o, a, s = k.createElement("div"),
  ...
  function Ge(e, t, n) {
    ...
    return a = a && (y.boxSizingReliable() || i === e.style[t]), ("auto" === i || !parseFloat(i) && "inline" === E.css(e, "display", !1, r)) && (i = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (i = parseFloat(i) || 0) + Ye(e, t, n || (o ? "border" : "content"), a, r, i) + "px"
  }
  ...
  E.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" == (o = typeof n) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (E.cssNumber[s] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
      }
    },
    css: function (e, t, n, r) {
      var i, o, a, s = X(t);
      return Fe.test(t) || (t = Ue(s)), (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Re(e, t, r)), "normal" === i && t in ze && (i = ze[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
    }
  }), E.each(["height", "width"], function (e, s) {
    E.cssHooks[s] = {
      get: function (e, t, n) {
        if (t) return !We.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, s, n) : ie(e, _e, function () {
          return Ge(e, s, n)
        })
      },
      set: function (e, t, n) {
        var r, i = Pe(e),
          ...
          a = n && Ye(e, s, n, o, i);
        return o && y.scrollboxSize() === i.position && (a -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - Ye(e, s, "border", !1, i) - .5)), a && (r = te.exec(t)) && "px" !== (r[3] || "px") && (e.style[s] = t, t = E.css(e, s)), Ve(0, t, a)
      }
    }
  }), E.cssHooks.marginLeft = Be(y.reliableMarginLeft, function (e, t) {
    ...
    }, "margin" !== i && (E.cssHooks[i + o].set = Ve)
  }), E.fn.extend({
    css: function (e, t) {
      return F(this, function (e, t, n) {
        var r, i, o = {},
          a = 0;
        if (Array.isArray(t)) {
          for (r = Pe(e), i = t.length; a < i; a++) o[t[a]] = E.css(e, t[a], !1, r);
          return o
        }
  ...
  function it() {
    Ze && (!1 === k.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(it) : C.setTimeout(it, E.fx.interval), E.fx.tick())
  }
  ...
  function ut(o, e, t) {
    ...
    for (function (e, t) {
      ...
      if (n = ut.prefilters[r].call(l, o, c, l.opts)) return v(n.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n;
    return E.map(c, st, l), v(l.opts.start) && l.opts.start.call(o, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), E.fx.timer(E.extend(u, {
      elem: o,
      anim: l,
      queue: l.opts.queue
    })), l
  ...
  E.Animation = E.extend(ut, {
    ...
    tweener: function (e, t) {
      for (var n, r = 0, i = (e = v(e) ? (t = e, ["*"]) : e.match(I)).length; r < i; r++) n = e[r], ut.tweeners[n] = ut.tweeners[n] || [], ut.tweeners[n].unshift(t)
    },
    prefilters: [function (e, t, n) {
      ...
      if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(d))
        for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = m && m.display) && (l = Y.get(e, "display")), "none" === (c = E.css(e, "display")) && (l ? c = l : (se([e], !0), l = e.style.display || l, c = E.css(e, "display"), se([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === E.css(e, "float") && (u || (p.done(function () {
            h.display = l
  ...
  }, et = k.createElement("input"), tt = k.createElement("select").appendChild(k.createElement("option")), et.type = "checkbox", y.checkOn = "" !== et.value, y.optSelected = tt.selected, (et = k.createElement("input")).value = "t", et.type = "radio", y.radioValue = "t" === et.value;
  ...
  E.extend(E.event, {
    trigger: function (e, t, n, r) {
      ...
      if (o = f = a = n = n || k, 3 !== n.nodeType && 8 !== n.nodeType && !yt.test(d + E.event.triggered) && (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, (e = e[E.expando] ? e : new E.Event(d, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), c = E.event.special[d] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
        ...
        for (i = 0;
          (o = p[i++]) && !e.isPropagationStopped();) f = o, e.type = 1 < i ? s : c.bindType || d, (l = (Y.get(o, "events") || {})[e.type] && Y.get(o, "handle")) && l.apply(o, t), (l = u && o[u]) && l.apply && U(o) && (e.result = l.apply(o, t), !1 === e.result && e.preventDefault());
        return e.type = d, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(p.pop(), t) || !U(n) || u && v(n[d]) && !x(n) && ((a = n[u]) && (n[u] = null), E.event.triggered = d, e.isPropagationStopped() && f.addEventListener(d, vt), n[d](), e.isPropagationStopped() && f.removeEventListener(d, vt), E.event.triggered = void 0, a && (n[u] = a)), e.result
      }
    },
  ...
  function jt(n, e, r, i) {
    ...
    if (Array.isArray(e)) E.each(e, function (e, t) {
      r || Tt.test(n) ? i(n, t) : jt(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, r, i)
    });
  ...
  Ht.href = xt.href, E.extend({
    ...
    ajax: function (e, t) {
      ...
      var c, f, p, n, d, r, h, g, i, o, m = E.ajaxSetup({}, t),
        y = m.context || m,
        v = m.context && (y.nodeType || y.jquery) ? E(y) : E.event,
        x = E.Deferred(),
      ...
      if (x.promise(T), m.url = ((e || m.url || xt.href) + "").replace(qt, xt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(I) || [""], null == m.crossDomain) {
        r = k.createElement("a");
        try {
      ...
      if (m.data && m.processData && "string" != typeof m.data && (m.data = E.param(m.data, m.traditional)), $t(Lt, m, t, T), h) return T;
      for (i in (g = E.event && m.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !Ot.test(m.type), f = m.url.replace(At, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(St, "+")) : (o = m.url.slice(f.length), m.data && (m.processData || "string" == typeof m.data) && (f += (wt.test(f) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (f = f.replace(Dt, "$1"), o = (wt.test(f) ? "&" : "?") + "_=" + bt++ + o), m.url = f + o), m.ifModified && (E.lastModified[f] && T.setRequestHeader("If-Modified-Since", E.lastModified[f]), E.etag[f] && T.setRequestHeader("If-None-Match", E.etag[f])), (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && T.setRequestHeader("Content-Type", m.contentType), T.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + It + "; q=0.01" : "") : m.accepts["*"]), m.headers) T.setRequestHeader(i, m.headers[i]);
      if (m.beforeSend && (!1 === m.beforeSend.call(y, T, m) || h)) return T.abort();
      if (u = "abort", b.add(m.complete), T.done(m.success), T.fail(m.error), c = $t(Mt, m, t, T)) {
  ...
  y.cors = !!Wt && "withCredentials" in Wt, y.ajax = Wt = !!Wt, E.ajaxTransport(function (i) {
    var o, a;
    if (y.cors || Wt && !i.crossDomain) return {
      send: function (e, t) {
        var n, r = i.xhr();
  ...
  E.ajaxSetup({
    ...
    if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = v(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(zt, "$1" + r) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
      return o || E.error(r + " was not called"), o[0]
    }, e.dataTypes[0] = "json", i = C[r], C[r] = function () {
      o = arguments
    }, n.always(function () {
      void 0 === i ? E(C).removeProp(r) : C[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, _t.push(r)), o && v(i) && i(o[0]), o = i = void 0
    }), "script"
  }), y.createHTMLDocument = ((Ft = k.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ft.childNodes.length), E.parseHTML = function (e, t, n) {
    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((r = (t = k.implementation.createHTMLDocument("")).createElement("base")).href = k.location.href, t.head.appendChild(r)) : t = k), o = !n && [], (i = A.exec(e)) ? [t.createElement(i[1])] : (i = ye([e], t, o), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
    var r, i, o
  }, E.fn.load = function (e, t, n) {
    var r, i, o, a = this,
      s = e.indexOf(" ");
    return -1 < s && (r = dt(e.slice(s)), e = e.slice(0, s)), v(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 0 < a.length && E.ajax({
      url: e,
      type: i || "GET",
      dataType: "html",
      data: t
    ...
    setOffset: function (e, t, n) {
      var r, i, o, a, s, u, l = E.css(e, "position"),
        c = E(e),
        f = {};
      "static" === l && (e.style.position = "relative"), s = c.offset(), o = E.css(e, "top"), u = E.css(e, "left"), i = ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (a = (r = c.position()).top, r.left) : (a = parseFloat(o) || 0, parseFloat(u) || 0), v(t) && (t = t.call(e, n, E.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
    }
  }, E.fn.extend({
    offset: function (t) {
    ...
    E.cssHooks[n] = Be(y.pixelPosition, function (e, t) {
      if (t) return t = Re(e, n), He.test(t) ? E(e).position()[n] + "px" : t
    })
  }), E.each({
    Height: "height",
    Width: "width"
  ...
  }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = S, E.isFunction = v, E.isWindow = x, E.camelCase = X, E.type = w, E.now = Date.now, E.isNumeric = function (e) {
    var t = E.type(e);
  ...
  return E.noConflict = function (e) {
    return C.$ === E && (C.$ = Xt), e && C.jQuery === E && (C.jQuery = Qt), E
  }, e || (C.jQuery = C.$ = E), E
}),
function (o, e, t, n) {
  var a, r;
  (a = function (e) {
    this.revision = this.build = this.minor = this.major = this.original = null, this.initialize(e)
  }).prototype.initialize = function (e) {
    var t = e.split(".");
    this.original = e, this.major = t && t[0] ? parseInt(t[0], 10) : null, this.minor = t && t[1] ? parseInt(t[1], 10) : null, this.build = t && t[2] ? parseInt(t[2], 10) : null, this.revision = t && t[3] ? parseInt(t[3], 10) : null
  }, a.prototype.isEqual = function (e, t, n, r) {
    return "number" == typeof e && ("number" != typeof t ? this.major === e : "number" != typeof n ? this.major === e && this.minor === t : "number" != typeof r ? this.major === e && this.minor === t && this.build === n : this.major === e && this.minor === t && this.build === n && this.revision === r)
  }, a.prototype.isOrLess = function (e, t, n, r) {
    return "number" == typeof e && (this.major !== e ? this.major < e : "number" != typeof t || (this.minor !== t ? this.minor < t : "number" != typeof n || (this.build !== n ? this.build < n : "number" != typeof r || (this.revision === r || this.revision < r))))
  }, a.prototype.isLessThan = function (e, t, n, r) {
    return "number" == typeof e && (this.major !== e ? this.major < e : "number" == typeof t && (this.minor !== t ? this.minor < t : "number" == typeof n && (this.build !== n ? this.build < n : "number" == typeof r && (this.revision !== r && this.revision < r))))
  }, a.prototype.isOrMore = function (e, t, n, r) {
    return "number" == typeof e && (this.major !== e ? this.major > e : "number" != typeof t || (this.minor !== t ? this.minor > t : "number" != typeof n || (this.build !== n ? this.build > n : "number" != typeof r || (this.revision === r || this.revision > r))))
  }, a.prototype.isMoreThan = function (e, t, n, r) {
    return "number" == typeof e && (this.major !== e ? this.major > e : "number" == typeof t && (this.minor !== t ? this.minor > t : "number" == typeof n && (this.build !== n ? this.build > n : "number" == typeof r && (this.revision !== r && this.revision > r))))
  }, a.prototype.toString = function () {
    return this.original
  }, (e = function () {
    this.original = "", this.version = null, this.initialize(o.navigator.userAgent)
  }).prototype.initialize = function (e) {
    var t, n = "",
      r = t = "",
      i = null;
    i = 0 <= (e = e.toLowerCase()).indexOf("opera") || 0 <= e.lastIndexOf("opr") ? 0 <= e.indexOf("opera mini") ? (n = "operamini", (t = /opera mini\/([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("opera mobi") ? (n = "operamobile", (t = /version\/([\d\.]+)/.exec(e)) ? t[1] : "") : (n = "opera", (t = /version\/([\d\.]+)/.exec(e)) ? t[1] : (t = /(?:opera|opr)[\s\/]+([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("edge") ? (n = "edge", (t = /edge\/([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("msie") || 0 <= e.indexOf("trident") ? (n = "msie", (t = /(msie|rv:?)\s?([\d\.]+)/.exec(e)) ? t[2] : "") : 0 <= e.indexOf("firefox") ? (n = "firefox", (t = /firefox\/([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("chrome") || 0 <= e.indexOf("crios") ? (n = "chrome", (t = /[chrome|crios]\/([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("android") ? (n = "browser", (t = /version\/([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("silk") ? (n = "silk", (t = /silk\/([\d\.]*)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("mercury") ? (n = "mercury", (t = /mercury\/([\d\.]+)/.exec(e)) ? t[1] : "") : 0 <= e.indexOf("safari") ? (n = "safari", (t = /version\/([\d\.]+)/.exec(e)) ? t[1] : "") : (n = "unknown", ""), t = 0 <= e.indexOf("edge") ? "edge" : 0 <= e.indexOf("webkit") ? "webkit" : 0 <= e.indexOf("trident") ? "trident" : 0 <= e.indexOf("presto") ? "presto" : 0 <= e.indexOf("khtml") ? "khtml" : 0 <= e.indexOf("gecko") ? "gecko" : "unknown", r = 0 <= e.indexOf("arm") ? "arm" : 0 <= e.indexOf("win64") ? 0 <= e.indexOf("ia64") ? "ia64" : "x64" : "x86", this.original = n, this[n] = !0, this[t] = !0, this[r] = !0, this.version = o.__BACKWARD_COMPATIBILITY_ENABLED ? i : new a(i)
  }, e.prototype.is = function (e) {
    return "string" == typeof e && e.toLowerCase() === this.original
  }, (r = function () {
    this.original = "", this.initialize(o.navigator.userAgent)
  }).prototype.initialize = function (e) {
    var t = "",
      n = "",
      r = "",
      i = "";
    n = null;
    e = e.toLowerCase(), (n = /iphone|ipod|ipad|android|windows phone|silk|blackberry|symbian|mobile/.exec(e)) ? n = 0 <= e.indexOf("silk") ? (t = "tablet", "android") : (t = 0 <= e.indexOf("android") && e.indexOf("mobile") < 0 || 0 <= e.indexOf("ipad") ? "tablet" : "mobile", n[0].replace(" ", "")) : r = 0 <= e.indexOf("windows") ? (t = "pc", n = "windows", i = (r = /windows nt ([\d\.]+)/.exec(e)) ? r[1] : "", 0 <= e.indexOf("arm") ? "arm" : 0 <= e.indexOf("win64") ? 0 <= e.indexOf("ia64") ? "ia64" : "x64" : 0 <= e.indexOf("wow64") ? "x64" : "x86") : (n = 0 <= e.indexOf("mac") ? (t = "pc", "mac") : 0 <= e.indexOf("linux") ? (t = "pc", "linux") : t = "unknown", "unknown"), this.type = t, this.original = n, this[t] = !0, this[n] = !0, this[r] = !0, this.version = new a(i)
  }, r.prototype.is = function (e) {
    return "string" == typeof e && ((e = e.toLowerCase()) === this.original || e === this.type)
  }, t.browser = new e, t.platform = new r, t.depend = function () {
    var e, t, n, r;
    for (e = 0, t = (n = arguments).length; e < t; e++)
      if ((!0 === (r = n[e]).on || void 0 === r.on) && "function" == typeof r.exe) return r.exe();
    o.console && o.console.log && o.console.log('Not implemented default process in "$.depend" function.')
  }
